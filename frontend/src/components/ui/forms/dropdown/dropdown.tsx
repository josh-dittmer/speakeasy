...
export default function Dropdown({ options, selectedOption, setSelectedOption, title, submitted, setValid }: DropdownProps) {
    ...
    return (
        <div className="dropdown">
            ...
            <div className="">
                <select value={selectedOption} onChange={(e) => handleChange(e.target.value)} className="bg-bg-light text-fg-dark p-3 rounded outline-none">
                    {options.map((option) => {
